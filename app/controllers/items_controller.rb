class ItemsController < ApplicationController
  ...
  def item_params
    params.require(:item).permit(:name,:description,:delivery_fee,:price,:brand_id,:prefecture_id,:category_id,:size_id,:item_status_id,:delivery_status_id,:delivery_method_id,
    images_attributes: [:id, :image]).merge(user_id:1,delivery_method_id:1, category_id: 1,brand_id:1,size_id: 1, sale_status_id: 1)
